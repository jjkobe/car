...
function carKey(car) {
  ...
  var speedUp = new staticImg(resourceLoader.get('up'), new Vector(3*gnfx/400, 500*gnfy/710), 40*gnfx/400, 55*gnfy/710);
  var speedDown = new staticImg(resourceLoader.get('down'), new Vector(3*gnfx/400, 600*gnfy/710), 40*gnfx/400, 55*gnfy/710);
  var speedRight = new staticImg(resourceLoader.get('right'), new Vector(355*gnfx/400, 600*gnfy/710), 40*gnfx/400, 55*gnfy/710);
  var speedLeft = new staticImg(resourceLoader.get('left'), new Vector(355*gnfx/400, 500*gnfy/710), 40*gnfx/400, 55*gnfy/710);
