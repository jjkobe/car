function setHtmlSize(){
  ...
  document.getElementById('hitAvoid').style.height=0.25*windowHeight+'px';
  document.getElementById('hitBack').style.height=0.25*windowHeight+'px';
  document.getElementById('hitLine').style.height=0.25*windowHeight+'px';
  ...
  document.getElementById('hitAvoid').style.width=0.8*windowWidth+'px';
  document.getElementById('hitBack').style.width=0.8*windowWidth+'px';
  document.getElementById('hitLine').style.width=0.8*windowWidth+'px';
  ...
  document.getElementById('tipcline').style.height=0.4*windowHeight+'px';
